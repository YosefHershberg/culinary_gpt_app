      ...
      <div className=" nt p-10 h-[calc(100vh-4rem)] w-full flex md:flex-row flex-col gap-5">
        ...
        >
          <div className='flex flex-col md:items-start items-center gap-8 md:h-[clamp(10rem,70vh,40rem)] justify-between'>
            ...
            <Button variant='link' className='hover:scale-110 transition-all duration-200 font-bold flex items-center gap-2 text-lg'>
        ...
        >
          <img className='object-contain max-w-[40rem] md:w-full w-2/3 min-w-[20rem]' src={kitchentools} alt="" />
        </motion.div>
      </div>
      <About />
      <Footer />
